...
// Detailed room art (props, textures). Full scene on back canvas; front layer clear so sprites paint above furniture.
// Palette key:
//   wall/wHi/wLo  wall surface shades
//   floor/fLo     floor shades
//   ink           sharpest dark (outlines)
//   dk            very dark (furniture frames, shadows)
//   md            mid-gray (secondary furniture faces)
//   sg            soft gray (fills, rugs, accents)
//   lt            near-white detail (highlights)
...
// ΓöÇΓöÇ Drawing primitives ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

function _base(ctx, C) {
  // Wall ΓÇö clean flat fill with a single soft top-edge light
  ...
  // Floor ΓÇö slightly warmer/different from wall so depth reads
...
// Floor textures ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// Ceiling lamp light pool ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Room draw functions ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function _drawStudy(ctx, C) {
  ...
  // Desk clutter ΓÇö coffee mug, notepad
...
function _drawMusic(ctx, C) {
  _base(ctx, C)
  _floorPlanks(ctx, C)
  // Soundproof foam diamond pattern ΓÇö darker on white walls so it's visible
  ctx.fillStyle = C.sg; ctx.globalAlpha = 0.22
  const fs = 12
...
function _drawRoomLayers(backCtx, frontCtx, room) {
  ...
  const draw = ROOM_DRAW[room.typeId] || ROOM_DRAW.study
  backCtx.save()
  frontCtx.save()
...
function _buildOutdoorDOM(room) {
  ...
  // Mid-depth tree line silhouette
  const trees = document.createElement('div')
  trees.className = 'out-treeline'
  for (let i = 0; i < 18; i++) {
    const t = document.createElement('div')
    t.className = 'out-treeline-t'
    t.style.height = (10 + Math.random() * 14).toFixed(0) + 'px'
    trees.appendChild(t)
  }
